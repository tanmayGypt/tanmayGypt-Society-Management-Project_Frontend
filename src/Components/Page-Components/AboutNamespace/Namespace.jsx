...
import SocietyNavbar from "../../Common-Components/SocietyNavbar";
      ...
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row">
          ...
          <div className="flex sm:flex-col sm:py-10 w-full sm:w-1/5 py-3 items-center px-10 justify-center sm:items-center gap-x-5 sm:gap-y-10">
            <button className=" bg-violet-50 text-black  py-2 px-2 rounded-3xl w-28 text-xl font-medium shadow-lg">
              Vision
            </button>
            <button className="  bg-violet-50 text-black  py-2 px-2 rounded-3xl w-28 text-xl font-medium shadow-lg">
              Misson
          ...
          <div className="my-10 py-10 px-5 tracking-wider text-xl ">
            <p className="py-5 ">
              To transform India into a Global Developer Powerhouse.
            </p>
            <p>
              To make a peer group for the holistic development of the student
            </p>
            <button className="m-4 bg-violet-50 text-black font-medium py-1 px-2 rounded-3xl w-44 text-xl shadow-lg">
              Read More...
            </button>
          </div>
        </div>
