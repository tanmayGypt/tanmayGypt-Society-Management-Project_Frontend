          ...
          <form className="grid grid-cols-1 lg:grid-cols-3 gap-5 mx-5">
            ...
            <div>
              ...
              <select
                id="society_category"
                name="category"
                className="mt-1 p-2 block w-full border border-gray-600 rounded-md shadow-sm sm:text-sm"
                required
              >
            ...
            <div className=" row-span-4 lg:col-span-1 lg:col-start-3 ">
              <label
                htmlFor="society_description"
                className="block text-md font-medium text-gray-700"
              >
                Society's Description
              </label>
              <textarea
                id="society_description"
                name="description"
                className="mt-1 p-2 block w-full border border-gray-600 rounded-md shadow-sm sm:text-sm"
                placeholder="Enter society's description"
                rows={14}
                required
              ></textarea>
            </div>
            ...
            <div className="md:col-span-3 flex justify-center pb-2">
              <button
                type="submit"
                className="mt-4 bg-orange-500 text-white font-bold py-2 px-4 rounded-lg"
                onClick={(e) => {
                  e.preventDefault();
                }}
              >
